        ...
        <>
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className={cn(
                "bg-white rounded-2xl sm:rounded-3xl border-4 border-[var(--color-border-base)] w-full max-h-[90vh] overflow-y-auto no-scrollbar pointer-events-auto shadow-2xl flex flex-col",
